...
class RestaurantSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        for ($i = 0; $i < $numRecords; $i++) {
            ...
            $new_restaurant->phone_number = $phone_numbers[$i];
            $new_restaurant->restaurant_name = $restaurant_names[$i];
            $new_restaurant->img = $images[$i];
            $new_restaurant->description = $descriptions[$i];
            $new_restaurant->address = $addresses[$i];
            $new_restaurant->p_iva = $p_iva[$i];
            $new_restaurant->save();
        }
